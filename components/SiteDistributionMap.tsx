              ...
              <span key={site.id}>
                {pilotSiteIdSet.has(site.id) && (
                  <span
                    ...
                    className="absolute h-5 w-5 rounded-full border-2 border-fuchsia-500 bg-fuchsia-200/20 shadow-sm shadow-fuchsia-200"
          ...
          {carrierOffices.map((office) => {
            ...
            return (
              <span
                ...
                className="absolute grid h-4 w-4 place-items-center rounded-sm border-2 border-white bg-slate-950 shadow-md"
